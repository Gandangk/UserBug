...
async def who(event):
    ...
    await event.edit(
        "`Wait a minute... Searching info about this retarded user...`")
...
async def fetch_info(replied_user, event):
    ...
    caption += f"Is Restricted: restricted,cuz gay\n"
    caption += f"Is Verified by Telegram: verified,and definitely gay user\n"
